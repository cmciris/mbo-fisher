...
def main(out_dir="./", samples=15, fontsize=12,
    ...
    rembo_id = "0912043548"
    rembo_x = np.load(os.path.join("../logs/rembo_ridge/", rembo_id + "_pred_x.npy"))
    rembo_y = np.load(os.path.join("../logs/rembo_ridge/", rembo_id + "_pred_y.npy"))
    rembo_xy = np.concatenate([rembo_x, rembo_y], axis=-1)
    rim_id = "0912042643"
    ...
    models = [grad_xy, coms_xy, iom_xy, rembo_xy, rim_xy]
